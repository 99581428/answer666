...
REGION = "cn-hangzhou"
ACCESS_KEY_ID = "LTAI4FmhChcyZeS7C1ZwTE7M"
ACCESS_KEY_SECRET = "HLtcMkApwDJYbfDzIeYY4jql3J3nAk"
...
def send_sms_view(request):
    ...
    params = "{\"code\":\"" + code + "\"}"
    send_sms(business_id, phone, "云题答案查找中心", "SMS_174580760", params)
    cache.set(phone, code, timeout=600)
    return True
def checkPhoneCode(phone,code):
